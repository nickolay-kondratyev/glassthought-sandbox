...
```bash
gt.sandbox.checkout.commit a57911d940e51524fa0a \
&& cd "${GT_SANDBOX_REPO}" \
...
```txt
Registered: ConcreteHandlerA
Registered: ConcreteHandlerB
Duplicate detected not registered: ConcreteHandlerA
Registered handlers: [ConcreteHandlerA, ConcreteHandlerB]
```
