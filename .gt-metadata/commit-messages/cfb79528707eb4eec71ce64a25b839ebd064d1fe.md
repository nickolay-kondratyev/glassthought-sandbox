...
```bash
gt.sandbox.checkout.commit cfb79528707eb4eec71c \
&& cd "${GT_SANDBOX_REPO}" \
...
Time taken without mutex: 5901041 ns
Counter with mutex: 100000000
Time taken with mutex: 2190159083 ns
Overhead of Mutex.withLock{} per operation: 21 ns
In relation to millisecond how many times can we take mutex in one millisecond: 47619
```
