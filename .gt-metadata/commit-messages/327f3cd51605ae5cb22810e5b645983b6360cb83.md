...
```bash
gt.sandbox.checkout.commit 327f3cd51605ae5cb228 \
&& cd "${GT_SANDBOX_REPO}" \
...
> Task :app:run
[2024-11-22T05:22:55.700473Z][elapsed-since-start:   43ms][tname:main/tid:1] Fallback Result (java.lang.RuntimeException: original-exc-msg-from-supplyAsync-future-block)
