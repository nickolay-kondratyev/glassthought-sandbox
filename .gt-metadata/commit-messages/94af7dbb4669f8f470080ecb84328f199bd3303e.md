...
```bash
gt.sandbox.checkout.commit 94af7dbb4669f8f47008 \
&& cd "${GT_SANDBOX_REPO}" \
...
```txt
[elapsed:   22ms][🥇/tname:main/tid:1][coroutine:unnamed] Hello, world!
[elapsed:   45ms][⓶/tname:Thread-0/tid:20][coroutine:unnamed] Sleeping
[elapsed: 1055ms][⓶/tname:Thread-0/tid:20][coroutine:unnamed] Done Sleeping
[elapsed: 1055ms][⓷/tname:kotlinx.coroutines.DefaultExecutor/tid:21][coroutine:unnamed] Goodbye, world!
```
